...
if (isset($_POST['action']))
{
    if ($_POST['action'] == "submit")
	{
		...
		{
			$to = "Nightify <summitsingh5@gmail.com>";
			$subject = 'Contact Us Form - '.$subject.' - Nightify';
			$from = $name.' <'.$email.'>';
			$body='Hi Admin,<br><br>==================================================================<br>Below is the message sent by '.$name.':<br>==================================================================<br><br>'.$bodycontent.'<br><br>==================================================================<br><br>Thank you,<br>Nightify Team<br><br><img src="http://icons.iconarchive.com/icons/itzikgur/my-seven/256/Girls-Red-Dress-icon.png" width="100px" alt="Nightify">';
			$headers = "From: " . $from . "\r\n";
