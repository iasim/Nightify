...
<h6>Project Manager and Lead Developer</h6>
    <span class="media-left">
        <img src="/images/aboutus/summit.jpg" width="120p" alt="...">
    </span>
    <div class="media-body">
        <p class="media-heading">The person in-charge of your data and the back-end of the website. He enjoys rap-music and travelling around Philly.  If you find any weird-behaviour with the website, you can find him at summitsingh5@gmail.com</p>
    </div>
</div>
<hr>
...
<div class="media">
<h4>Faizan Shahzad</h4>
<h6>Marketing Manager</h6>
    <span class="media-left">
        <img src="/images/aboutus/faizan.jpg" width="120p" alt="...">
    </span>
    <div class="media-body">
        <p class="media-heading">Found some flyers where they shouldn't be? This man is to blame! Faizan is in-charge of the Marketing aspects of Drexsell and enjoys playing Pokemon and FIFA. Shoot him an email at fs372@drexel.edu.</p>
    </div>
</div>
<hr>
...
<h6>Designer</h6>
    ...
    <div class="media-body">
        <p class="media-heading">Shoot him an email at cp676@drexel.edu.</p>
    </div>
</div>
<hr>
