...
if(isset($_POST['action']))
{
	if($_POST['action']=="submit")
	{
		...
		if($users>=1)
		{
			...
			$to = $users['name']." <".$email.">";
			$subject="Forgot Password - Nightify";
			$from = "Nightify <summitsingh5@gmail.com>";
			$body='Hi '.$users['name'].',<br><br>Click the link to reset your password <a href="https://'.$_SERVER["HTTP_HOST"].'/forgotpassword.php?email='.$email.'&encrypt='.$encrypt.'&action=reset">https://'.$_SERVER["HTTP_HOST"].'/forgotpassword.php?email='.$email.'&encrypt='.$encrypt.'&action=reset</a><br><br>Thank you,<br>Nightify Team<br><br>
			<img src="http://icons.iconarchive.com/icons/itzikgur/my-seven/256/Girls-Red-Dress-icon.png" width="100px" alt="Nightify">';
			$headers = "From: " . $from . "\r\n";
